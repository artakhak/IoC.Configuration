...
var templateFileRelativePaths = new (string, string)[]
{
    ...
    ("README.md.template", @"IoC.Configuration\README.md"),
    ...
    (@"docs\xml-configuration-file\autogenerated-services\element-auto-service.rst.template", "element-auto-service.generated.rst"),
    ...
    (@"docs\application-integration\asp-net\index.rst.template", "index.generated.rst"),
    (@"docs\application-integration\maui\index.rst.template", "index.generated.rst"),
    (@"docs\application-integration\winui3\index.rst.template", "index.generated.rst"),
    
    (@"docs\loading-ioc-configuration\loading-from-xml.rst.template", "loading-from-xml.generated.rst"),
    (@"docs\xml-configuration-file\value-initialization-elements\provided-value.rst.template", "provided-value.generated.rst"),
