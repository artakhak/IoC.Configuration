...
REM k:
REM cd "K:\Projects\OROptimizer\MyGitHubProjects\IoC.Configuration\ApplicationIntegrationDemos\Maui\SetupScripts"
...
SET "IoCConfigurationFiles=%SolutionDir%ApplicationIntegrationDemos\Maui\MauiDemo\bin\IoCConfigurationFiles"
...
xcopy "%SolutionDir%ApplicationIntegrationDemos\Maui\MauiDemo.Extension\bin\Debug\net8.0\MauiDemo.Extension.*"  "%PluginDlls%\MauiDemoExtension" /Y
