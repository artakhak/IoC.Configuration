...
REM if not exist "K:\Projects\OROptimizer\MyGitHubProjects\IoC.Configuration\ApplicationIntegrationDemos\ASP.NET.WebApi\WebApiDemo\bin\%CONFIG%\net8.0" (
REM     echo Creating directory: bin\%CONFIG%\net8.0
REM     mkdir "K:\Projects\OROptimizer\MyGitHubProjects\IoC.Configuration\ApplicationIntegrationDemos\ASP.NET.WebApi\WebApiDemo\bin\%CONFIG%\net8.0"
REM )
