...
- Execute ExecuteCopyFiles.bat if it was not yet executed, and execute it after modifications to projects WebApiDemo.DynamicallyLoadedControllers.csproj and WebApiDemo.Extension.csproj (build these projects first, since the script copies the dlls)
