...
REM k:
REM cd "K:\Projects\OROptimizer\MyGitHubProjects\IoC.Configuration\ApplicationIntegrationDemos\WinUI3\SetupScripts"
...
SET "IoCConfigurationFiles=%SolutionDir%ApplicationIntegrationDemos\WinUI3\WinUI3Demo\bin\IoCConfigurationFiles"
...
if not exist "%PluginDlls%\WinUI3Extension" mkdir "%PluginDlls%\WinUI3DemoExtension"

xcopy "%SolutionDir%ApplicationIntegrationDemos\WinUI3\WinUI3Demo.Extension\bin\Debug\net8.0\WinUI3Demo.Extension.*"  "%PluginDlls%\WinUI3DemoExtension" /Y
